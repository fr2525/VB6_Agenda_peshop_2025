...
'***************************************************************************************
'                              
sql = "CREATE TABLE tab_animais  (ID AUTOINCREMENT NOT NULL
...
'****************************************************************************************
'                              
sql = "CREATE TABLE tab_tipos_an (ID AUTO INCREMENT NOT NULL
...
'****************************************************************************************
'                              
sql = "CREATE TABLE tab_servicos (ID AUTO INCREMENT NOT NULL
								, Descricao character(50) NOT NULL
								, valor NUMERIC(12,2)
...
'****************************************************************************************
'                              
sql = "CREATE TABLE tab_vacinas (ID AUTO INCREMENT NOT NULL 
								,IdAnimal integer NOT NULL
...
'****************************************************************************************
'                              
sql = "CREATE TABLE tab_promocoes (ID AUTO INCREMENT NOT NULL 
